...
All of the tables generated by measure.py can be passed an optional *cohorts* argument specifying additional labels for each observation by which the analysis should be grouped.
