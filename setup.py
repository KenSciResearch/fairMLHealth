...
def _get_version():
    ...
    version_file = os.path.join(
        os.path.abspath(os.path.dirname(__file__)), "version.json"
    )
...
tutorial_deps = ["fairlearn>=0.4.6", "lightgbm", "matplotlib", "seaborn", "xgboost"]
...
setup(
    ...
    extras_require={"test": test_deps, "tutorial": tutorial_deps},
